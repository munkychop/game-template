module.exports = function (grunt) {
    ...
    var _devTasks = ['clean:dist', 'js:dev', 'js:testAll', 'css:dev', 'images:dev', 'icons:dev', 'copy:markup'];
    var _serveTasks = _devTasks.concat(['browserSync:serve', 'watch']);
    var _distTasks = ['clean:dist', 'js:dist', 'js:testAll', 'css:dist', 'images:dist', 'icons:dist', 'copy:markup', 'copy:favicon'];
